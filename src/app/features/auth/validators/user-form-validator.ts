...
export class SaveUserFormValidator {
  private static readonly PREFIX = 'auth.register.form.validation.';
  ...
  static validate(form: UserFormModel): FieldError[] {
    ...
    FormValidationHelper.notBlank(errors, 'email', form.email, 'required');
  ...
  private static validateEmail(errors: FieldError[], email: string): void {
